---
display_name: AWS Workshop - EC2 (Linux) AWS Transform
description: Provision AWS EC2 VMs with AWS Transform and AWS development tools as Coder workspaces
icon: ../../../site/static/icon/aws.svg
maintainer_github: coder
verified: true
tags: [vm, linux, aws, persistent-vm, aws-transform, aws-cli, cdk]
---

# Remote Development on AWS EC2 VMs (Linux) with AWS Transform

Provision AWS EC2 VMs with integrated AWS Transform, AWS CLI, and AWS CDK as [Coder workspaces](https://coder.com/docs/workspaces) with this workshop template.
...
This template includes AWS Transform integration that provides:
...
- **AWS Transform**: AI-powered development assistance
...
### AWS Transform
AWS Transform is automatically installed and provides:
...
3. Initialize AWS Transform with appropriate authentication
4. Start developing with AI assistance using AWS Transform
